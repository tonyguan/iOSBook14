...
public class CoreDataDAO: NSObject {
    ...
    lazy var persistentStoreCoordinator: NSPersistentStoreCoordinator = {
        ...
        var pragmaOptions = [String : String]()
        pragmaOptions["synchronous"] = "OFF"
        pragmaOptions["count_changes"] = "OFF"
        pragmaOptions["journal_mode"] = "MEMORY"
        pragmaOptions["temp_store"] = "MEMORY"
        
        let storeOptions = [NSSQLitePragmasOption : pragmaOptions]
